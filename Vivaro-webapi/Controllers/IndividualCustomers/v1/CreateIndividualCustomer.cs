...
[ApiVersion("1.0")]
[ApiController]
public class CreateIndividualCustomer(ICreateIndividualCustomersUseCase useCase, Notification notification) : ControllerBase, IOutputPort
{
    
    private IActionResult? _viewModel;
    
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] CreateIndividualCustomerRequest request, CancellationToken cancellationToken)
    {
